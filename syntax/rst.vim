...
" Why is it making me put \zs before the linebreak?
syn match rstSections /\v^(([!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~])\2{3,})\zs\_.\_^.*\ze\_.\_^\1$/
syn match rstSections /\v^.*\ze\_.\_^(([!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~])\2{3,})$/

syn match rstTransition /\v^\s*\zs\_.\_^(([!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~])\2{3,})\ze\_.\_^\s*$/

" Needed for the 3-line section pattern above
