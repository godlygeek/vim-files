...
" A leading - before a bareword autoquotes
syn match  perlString "-\@<!-\s*\zs\I\i*\%(\%(::\|'\)\I\i*\)*\%(::\)\="
...
syn match perlSubNameSkip +\_s*+ contained nextgroup=perlSubPrototype
syn match perlSubName +\%(\h\|::\|'\w\)\%(\w\|::\|'\w\)*\|+ contained nextgroup=perlSubNameSkip

syn match perlFunctionSkip +\_s*+ contained nextgroup=perlSubName
syn match perlFunction +\<sub\>+ nextgroup=perlFunctionSkip
