...
hi Constant                 guifg=#EEDDAA  gui=none cterm=none
hi Statement                guifg=#CCEE00  gui=italic cterm=italic
hi StatementU               guifg=#CCEE00  gui=underline cterm=underline
hi Keyword                  guifg=#CCEE00
hi Underlined               guifg=#E0E0E0  gui=underline cterm=underline
hi Error                    guifg=#FFFFFF  guibg=#FF0000

" Tag syntax
hi Attribute                guifg=#CCCCCC  gui=italic cterm=italic
