...
vim.cmd("hi GitSignsAddLnInline guibg=#BAECBF")
vim.cmd("hi GitSignsChangeLnInline guibg=#BAECBF")
...
vim.cmd("hi GitSignsDeleteVirtLn guibg=#FCECEA")

vim.cmd("hi GitSignsAddLn guibg=#E0FAE3")
vim.cmd("hi GitSignsChangeLn guibg=#E0FAE3")
vim.cmd("hi GitSignsDeleteLn guibg=#FCECEA")
